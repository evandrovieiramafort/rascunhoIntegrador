...
VALUES (@cat_camisetas, '/src/assets/img/camisa sistemas.png', 'Camiseta Sistemas de Informação', 'Camiseta azul marinho com estampa exclusiva do curso de BSI.', '2026-1', 45.00, 0.00, 50, 100);

INSERT INTO item (categoria_id, foto, descricao, descricao_detalhada, periodo_lancamento, preco_venda, percentual_desconto, quantidade_estoque, total_vendas) 
VALUES (@cat_bones, '/src/assets/img/bone cefet.png', 'Boné CEFET/RJ', 'Boné azul marinho com bordado branco de alta qualidade.', '2025-2', 35.00, 10.00, 15, 85);

INSERT INTO item (categoria_id, foto, descricao, descricao_detalhada, periodo_lancamento, preco_venda, percentual_desconto, quantidade_estoque, total_vendas) 
VALUES (@cat_frio, '/src/assets/img/moletom cefet.png', 'Moletom CEFET/RJ Grafite', 'Moletom com capuz e estampa central clássica.', '2026-1', 130.00, 0.00, 20, 70);

INSERT INTO item (categoria_id, foto, descricao, descricao_detalhada, periodo_lancamento, preco_venda, percentual_desconto, quantidade_estoque, total_vendas) 
VALUES (@cat_bermudas, '/src/assets/img/bermuda cefet.png', 'Bermuda Sarja CEFET', 'Bermuda azul escuro em sarja, confortável e resistente.', '2026-1', 60.00, 0.00, 25, 60);

INSERT INTO item (categoria_id, foto, descricao, descricao_detalhada, periodo_lancamento, preco_venda, percentual_desconto, quantidade_estoque, total_vendas) 
VALUES (@cat_canecas, '/src/assets/img/caneca.png', 'Caneca Programador', 'Caneca de cerâmica branca com estampa lateral "Programador".', '2026-1', 35.00, 5.00, 40, 55);
